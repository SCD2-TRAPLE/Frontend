...
function Nickname() {
  ...
  const BackBtn = () => {
    navigate("/"); // 바로 이전 페이지로 이동 (닉네임의 이전페이지를 0.00페이지로 해야할지 아니면 정말 이전페이지로 해야할지)
  };
  ...
  return (
    ...
    <div style={styles.container}>
      ...
      <div style={styles.whitebox}>
          ...
          <h5 style={{marginTop: "0px", fontFamily: "Pretendard", fontSize: "20px", fontStyle: "normal", fontWeight: 400, lineHeight: "normal" }}>6글자 이내로 작성해주세요, 띄어쓰기 x</h5>
          <input placeholder='   트래플에서 사용할 닉네임을 입력해주세요.' style={styles.bar2}
